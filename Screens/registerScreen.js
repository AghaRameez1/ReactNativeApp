    ...
    return (
      <View style={{ flex: 1,paddingTop:20,paddingLeft:10, paddingRight:10, backgroundColor: 'red' }} >
        <View style={{ flex: .5, borderRadius: 20, backgroundColor: '#d9d9d9' }}>
          ...
          <CustomBtn OnPress={this.handlerButton} viewMarginTop={20} viewMarginRight={40} viewMarginLeft={30} viewElevation={50} backgroundColor='#02A266' alignItems='center' marginHorizontal={10} height={50} marginRight={20} justifyContent='center' borderRadius={5} textColor='#FFFF'>
